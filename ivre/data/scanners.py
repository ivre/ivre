...
UDP_PROBES = {
    ...
    ("Censys", "DTLS"),
    b"\x93\xd5\x01\x00\x00\x01\x00\x00\x00\x00\x00\x00\x03213\x011\x03168\x03192\x07in-addr\x04arpa\x00\x00\x0c\x00\x01": ("Censys", "DNS"),  # DNS query IN PTR 213.1.168.192.in-addr.arpa.  # noqa: E501
}
...
TCP_PROBES = {
    ...
    ("Nmap-modified", "niagara-fox-modified"),
}
