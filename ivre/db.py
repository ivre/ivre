...
class DB(object):
    ...
    We need daughter classes for each (backend, purpose) combination
    wanted.

    We also have backend-independent, purpose-specific daughter
    classes to factor some code, and purpose-independent,
    backend-specific classes for the same reason.

    The backend-specific purpose-specific classes inherits from both
    ...
    def _flt_and(self, cond1, cond2):
        ...
        This is typically implemented in the backend-specific daughter
        class.
    ...
    def searchcookie(self, name):
        ...
        purpose-specific daugher class.
    ...
    def get(self, spec, **kargs):
        ...
        typically implemented in the backend-specific daughter
        classes
...
class MetaDB(object):
    DB_TYPES = {
        "nmap": {"mongodb": MongoDBNmap},
        "passive": {"mongodb": MongoDBPassive},
        "data": {"mongodb": MongoDBData},
    }
    nmap = None
    passive = None
    data = None
