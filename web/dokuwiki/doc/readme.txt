...
[[https://www.mozilla.org/firefox/|Firefox]] and\\
[[http://www.chromium.org/|Chromium]])
  * Maxmind [[https://www.maxmind.com/en/geolocation_landing|GeoIP]]\\
free databases
...
[[https://github.com/cea-sec/ivre|repository]] on Github should be\\
used: feel free to create a new issue or a pull request!

You can also try to use the e-mail ''%%dev%%'' on the domain ''%%ivre.rocks%%'',\\
or to join the IRC chan [[irc://irc.freenode.net/%23ivre|#ivre]] on\\
